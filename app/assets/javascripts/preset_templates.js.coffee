...
presets = {
  encoder_preset: {
    ...
    audio: '-t @Maximum length to transcode@ -f mp4 -vn -acodec aac -strict -2 -ar @Audio samplerate@ -ab @Target bitrate@k -ac @Number of audio channels@ -alang @Language of audio track@'
  },
