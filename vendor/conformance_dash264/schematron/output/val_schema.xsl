...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="if (contains(@profiles, 'urn:com:dashif:dash264') and (count(descendant::dash:SegmentList/dash:SegmentURL) &gt; count(descendant::dash:SegmentList))) then false() else true()"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                xmlns:schold="http://www.ascc.net/xml/schematron"
                                xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="if (contains(@profiles, 'urn:com:dashif:dash264') and (count(descendant::dash:SegmentList/dash:SegmentURL) &gt; count(descendant::dash:SegmentList))) then false() else true()">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-get-full-path"/>
               </xsl:attribute>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="if (contains(@profiles, 'urn:com:dashif:dash264') and (contains(@profiles, 'urn:mpeg:dash:profile:isoff-live:2011') or @type = 'dynamic') and not(@maxSegmentDuration) ) then false() else true()"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                xmlns:schold="http://www.ascc.net/xml/schematron"
                                xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="if (contains(@profiles, 'urn:com:dashif:dash264') and (contains(@profiles, 'urn:mpeg:dash:profile:isoff-live:2011') or @type = 'dynamic') and not(@maxSegmentDuration) ) then false() else true()">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-get-full-path"/>
               </xsl:attribute>
               <svrl:text>DASH264 Section 3.2.2: "The attribute MPD@maxSegmentDuration shall be present" violated.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="if (contains(ancestor::dash:MPD/@profiles, 'urn:com:dashif:dash264') and dash:SegmentList) then false() else true()"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                xmlns:schold="http://www.ascc.net/xml/schematron"
                                xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="if (contains(ancestor::dash:MPD/@profiles, 'urn:com:dashif:dash264') and dash:SegmentList) then false() else true()">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-get-full-path"/>
               </xsl:attribute>
               <svrl:text>DASH264 Section 3.2.2: "the Period.SegmentList element shall not be present" violated here </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="if (contains(ancestor::dash:MPD/@profiles, 'urn:com:dashif:dash264') and (count(child::dash:AdaptationSet[@contentType='video']) &gt; 0) and (count(descendant::dash:Role[@value='main'])=0)) then false() else true()"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                xmlns:schold="http://www.ascc.net/xml/schematron"
                                xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="if (contains(ancestor::dash:MPD/@profiles, 'urn:com:dashif:dash264') and (count(child::dash:AdaptationSet[@contentType='video']) &gt; 0) and (count(descendant::dash:Role[@value='main'])=0)) then false() else true()">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-get-full-path"/>
               </xsl:attribute>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="if (contains(ancestor::dash:MPD/@profiles, 'urn:com:dashif:dash264') and @contentType='video' and not(@par)) then false() else true()"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                xmlns:schold="http://www.ascc.net/xml/schematron"
                                xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="if (contains(ancestor::dash:MPD/@profiles, 'urn:com:dashif:dash264') and @contentType='video' and not(@par)) then false() else true()">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-get-full-path"/>
               </xsl:attribute>
               <svrl:text> DASH264 Section 3.2.4: "For any Adaptation Sets with value of the @contentType="video" the following attributes shall be present: ... @par" violated here</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="if (contains(ancestor::dash:MPD/@profiles, 'urn:com:dashif:dash264') and @contentType='video' and @scanType) then false() else true()"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                xmlns:schold="http://www.ascc.net/xml/schematron"
                                xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="if (contains(ancestor::dash:MPD/@profiles, 'urn:com:dashif:dash264') and @contentType='video' and @scanType) then false() else true()">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-get-full-path"/>
               </xsl:attribute>
               <svrl:text> DASH264 Section 3.2.4: "For Adaptation Set or for any Representation within an Adaptation Set with value of the @contentType="video" the attribute @scanType must not be present" violated here</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="if (contains(ancestor::dash:MPD/@profiles, 'urn:com:dashif:dash264') and @contentType='audio' and not(@lang)) then false() else true()"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                xmlns:schold="http://www.ascc.net/xml/schematron"
                                xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="if (contains(ancestor::dash:MPD/@profiles, 'urn:com:dashif:dash264') and @contentType='audio' and not(@lang)) then false() else true()">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-get-full-path"/>
               </xsl:attribute>
               <svrl:text> DASH264 Section 3.2.4: "For any Adaptation Sets with value of the @contentType="audio" the following attributes shall be present: @lang" violated here</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="if (contains(ancestor::dash:MPD/@profiles, 'urn:com:dashif:dash264') and parent::dash:AdaptationSet/@contentType='video' and @scanType) then false() else true()"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                xmlns:schold="http://www.ascc.net/xml/schematron"
                                xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="if (contains(ancestor::dash:MPD/@profiles, 'urn:com:dashif:dash264') and parent::dash:AdaptationSet/@contentType='video' and @scanType) then false() else true()">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-get-full-path"/>
               </xsl:attribute>
               <svrl:text> DASH264 Section 3.2.4: "For Adaptation Set or for any Representation within an Adaptation Set with value of the @contentType="video" the attribute @scanType must not be present" violated here</svrl:text>
...
<xsl:template match="dash:Subset" priority="1000" mode="M19">
      <svrl:fired-rule xmlns:xs="http://www.w3.org/2001/XMLSchema"
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="if (@id = preceding-sibling::dash:Subset/@id) then false() else true()"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                xmlns:schold="http://www.ascc.net/xml/schematron"
                                xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="if (@id = preceding-sibling::dash:Subset/@id) then false() else true()">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-get-full-path"/>
               </xsl:attribute>
               <svrl:text>The id of each Subset within a Period shall be unique.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
